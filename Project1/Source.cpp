...
int main()
{
	...
	while (window.isOpen())
	{
		...
		else if ((green.getPosition().y >= 720 - 30 - green.getGlobalBounds().height)&&(green.getPosition().x >= space.getPosition().x  && green.getPosition().x - 10 <= space.getPosition().x + space.getGlobalBounds().width - green.getGlobalBounds().width + 10 /*&& green.getPosition().x >= space.getPosition().x - green.getGlobalBounds().width*/))
		{
